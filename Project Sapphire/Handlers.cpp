...
VOID GameStart()
{
	...
	*/
	...
	if(V_GMMode == TRUE)
	{
		Print(0, 1, "Project Ruby Dreams ÿc4version 5.43 is loadedÿc4 with ÿc5GM ÿc1mode active.");
	...
	{
		Print(0, 1, "Project Ruby Dreams ÿc4version 5.43 is loaded. Type ÿc2?help ÿc4for more information.");
	}
