...
//				0.5 - Guild Pact
//				0.6 - A New Hope
//				0.7 - Sands of Calypso
/////////////////////////////////////////////////////////
#define EXPANSIONTYPE					0		//Expansion set Type
#define EXPANSIONPACK					7		//Number of the expansion pack
...
#define WOWMOD							1		//Mofify input for World of Warcraft
...
#define ANTIQUESTBOX							//Hide the quest box
...
#define KEYITEMCODEXP1NO0				36563112
#define KEYITEMCODEXP1NO1				35633212
#define KEYITEMCODEXP1NO2				53735534
#define KEYITEMCODEXP1NO3				64866743
#define KEYITEMCODEXP1NO4				25724843
#define KEYITEMCODEXP1NO5				22623534
#define KEYITEMCODEXP2NO0				35722334
#define KEYITEMCODEXP2NO1				79492753
#define KEYITEMCODEXP2NO2				36854835
#define KEYITEMCODEXP2NO3				12455984
#define KEYITEMCODEXP3NO0				35665043
#define KEYITEMCODEXP3NO1				56837534
#define KEYITEMCODEXP3NO2				45274443
#define KEYITEMCODEXP3NO3				65833321
#define KEYITEMCODEXP3NO4				65386435
#define KEYITEMCODEXP3NO5				25724275
#define KEYITEMCODEXP4NO0				24525154
#define KEYITEMCODEXP4NO1				24722343
#define KEYITEMCODEXP4NO2				25471645
#define KEYITEMCODEXP4NO3				24755565
#define KEYITEMCODEXP4NO4				95693747
#define KEYITEMCODEXP4NO5				17285555
#define KEYITEMCODEXP5NO0				84623435
#define KEYITEMCODEXP5NO1				65653935
#define KEYITEMCODEXP5NO2				28823675
#define KEYITEMCODEXP5NO3				23575448
#define KEYITEMCODEXP5NO4				25473454
#define KEYITEMCODEXP6NO0				13573332
#define KEYITEMCODEXP6NO1				75714532
#define KEYITEMCODEXP6NO2				57543345
#define KEYITEMCODEXP6NO3				24572134
#define KEYITEMCODEXP6NO4				45726385
#define KEYITEMCODEXP7NO0				17553645
#define KEYITEMCODEXP7NO1				45843733
#define KEYITEMCODEXP7NO2				46451832
#define KEYITEMCODEXP7NO3				75473554
#define KEYITEMCODEXP8NO0				35754345
#define KEYITEMCODEXP8NO1				75473422
#define KEYITEMCODEXP8NO2				56253524
#define KEYITEMCODEXP8NO3				26253635
#define KEYITEMCODEXP8NO4				56223354
#define KEYITEMCODEXP9NO0				26563434
#define KEYITEMCODEXP9NO1				56523511
#define KEYITEMCODEXP9NO2				25653645
#define KEYITEMCODEXP9NO3				57553753
#define KEYITEMCODEXP9NO4				54723474
...
#define EXITDELAYLADDER					3000		//Delay intervals exiting game if ladder is busy
#define MESSAGEDELAY					10000		//Message fade delay
#define BUTTONDELAY						200			//Gamepad button delay

#define REITERATEDELAY					25			//How many times to delay exiting game.  Max 25			
...
#define	GMTAGX							527		//Location of the GM tag. Default 527 for Thunderer, 535 for Shikari
#define	GMTAGX2							121			//Location of the GM tag. Default 121 for Thunderer, 135 for Shikari
#define	GMNAMEOFFSETX					12			//Move your name to the side to make room for the GM flag. Default 12 for Thunderer, 0 for Shikari
//Keymaker
